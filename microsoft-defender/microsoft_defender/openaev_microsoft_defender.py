...
# "oaev-implant*" as an ancestor process.
#
...
# specific oaev-implant-<inject uuid> process, allowing for inferring
...
#
TH_API_QUERY = """
let null_if_not_implant_sig = (sig:string) { iff((sig startswith "oaev-implant"), sig, ""); };
