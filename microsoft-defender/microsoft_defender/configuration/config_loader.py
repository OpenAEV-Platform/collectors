from microsoft_defender.configuration.collector_config_override import (
        ...
        return Configuration(
            config_hints={
                ...
                "microsoft_defender_tenant_id": {
                    "data": self.collector.microsoft_defender_tenant_id
                },
                "microsoft_defender_client_id": {
                    "data": self.collector.microsoft_defender_client_id
                },
                "microsoft_defender_client_secret": {
                    "data": self.collector.microsoft_defender_client_secret.get_secret_value()
                },
            },
