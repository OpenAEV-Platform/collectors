"""Pydantic models for Microsoft Defender Graph Security API v2 alerts.

Intermediate representation between raw Graph API response and
DefenderSourceData. Validates alert structure and filters evidence
...
class AnalyzedMessageEvidence(BaseModel):
    """Analyzed message evidence from a Defender alert."""
...
class DefenderAlert(BaseModel):
    ...
    wrapping in DefenderSourceData.
    """
    ...
    def filter_evidence(self) -> dict[str, Any]:
        ...
        return {
            ...
            "incidentWebUrl": self.incident_web_url,
            "title": self.title,
    ...
    @classmethod
    def model_validate(cls, obj: dict[str, Any]) -> "DefenderAlert":
        ...
        Returns:
            A validated DefenderAlert instance with the raw dict preserved.
        """
