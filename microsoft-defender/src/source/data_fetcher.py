"""DefenderDataFetcher: fetches alerts from Microsoft Graph Security API v2.
...
class DefenderDataFetcher:
    """Implements DataFetcherProtocol for Microsoft Defender alerts.
