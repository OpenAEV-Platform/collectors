"""Essential tests for LogRhythm Expectation Service."""
...
class TestLogRhythmExpectationServiceEssential:
    """Essential test cases for LogRhythmExpectationService.

    Tests the core functionality of the LogRhythm expectation service including
    ...
    def test_init_without_config_raises_error(self):
        ...
        configuration raises a LogRhythmValidationError.
        """
        with pytest.raises(LogRhythmValidationError):
            LogRhythmExpectationService(config=None)
    ...
    def test_handle_batch_expectations_with_error(self):
        ...
        service.process_expectation = Mock(
            side_effect=LogRhythmExpectationError("Test error")
        )
    ...
    def test_prevention_expectation_not_supported(self):
        ...
        Verifies that LogRhythm correctly rejects prevention expectation
    ...
    def test_match_no_data_raises_exception(self):
        ...
        raises LogRhythmNoAlertsFoundError.
        """
        config = create_test_config()
        service = LogRhythmExpectationService(config=config)
    ...
    def test_match_no_matching_alerts_raises_exception(self):
        ...
        the service raises LogRhythmNoMatchingAlertsError.
        """
        config = create_test_config()
        service = LogRhythmExpectationService(config=config)
    ...
    def test_create_error_result_object(self):
        ...
        error = LogRhythmNoAlertsFoundError("No alerts found")
    ...
    def test_get_service_info(self):
        ...
        assert info["service_name"] == "LogRhythm"  # noqa: S101
