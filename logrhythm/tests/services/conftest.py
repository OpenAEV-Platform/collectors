...
@pytest.fixture
def mock_client_api():
    """Provide a mock LogRhythm client API.

    Returns:
        Mock LogRhythm client API instance for testing.
...
@pytest.fixture
def sample_alert():
    """Provide a sample LogRhythm alert.

    Returns:
        LogRhythmAlert instance for testing.

    """
    return LogRhythmAlertFactory.build()


@pytest.fixture
def sample_alerts():
    """Provide a list of sample LogRhythm alerts.

    Returns:
        List of 3 LogRhythmAlert instances for testing.

    """
    return [LogRhythmAlertFactory.build() for _ in range(3)]
...
@pytest.fixture
def mixed_logrhythm_data():
    """Provide mixed LogRhythm data (alerts).

    Returns:
        List containing LogRhythmAlert instances.

    """
    return TestDataFactory.create_mixed_logrhythm_data()
...
def api_response_data():
    ...
    Returns:
        Dictionary containing mock LogRhythm API response.
...
@pytest.fixture
def alert_factory():
    """Provide the LogRhythmAlertFactory for creating alerts.

    Returns:
        LogRhythmAlertFactory class for generating test alerts.

    """
    return LogRhythmAlertFactory
