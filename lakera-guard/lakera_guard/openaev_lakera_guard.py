...
from lakera_guard.client import LakeraClient
from lakera_guard.configuration.config_loader import ConfigLoader
...
class OpenAEVLakeraGuard(CollectorDaemon):
    """Validates Lakera Guard detection/prevention of AI adversarial injects by replaying each
    inject's attack content through the Lakera screening API and filling the DETECTION / PREVENTION
    ...
    def __init__(self, configuration: Configuration):
        super().__init__(
            ...
            collector_type="openaev_lakera_guard",
        )
            ...
            if inject_id not in verdicts:
                ...
                if not attack:
                    ...
                    try:
                        ...
                        self.logger.error(f"Lakera scan failed for inject {inject_id}: {exc}")
                        verdicts[inject_id] = None
                ...
                traces.append(
                    {
                        ...
                        "inject_expectation_trace_alert_name": verdict.detail or "Lakera Guard",
