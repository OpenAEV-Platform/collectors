...
class Collector(CollectorDaemon):
    ...
    def __init__(self) -> None:
        try:
            ...
            super().__init__(
                ...
                collector_type="openaev_http_logwatcher",
            )

            self.logger.info(
                f"{LOG_PREFIX} HTTP Logwatcher Collector initialized successfully"
            )
    ...
    def _setup(self) -> None:
        ...
        Initializes HTTP Logwatcher services, expectation handler, expectation manager,
    ...
    def _process_callback(self) -> None:
        ...
        try:
            ...
            self.logger.debug(
                f"{LOG_PREFIX} Processing expectations using HTTP Logwatcher services"
            )
