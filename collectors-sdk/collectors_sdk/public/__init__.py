"""Public API surface for collectors-sdk.

All 43 symbols re-exported here. Users import from:
    from collectors_sdk import BaseCollector, BasicCollectorEngine
    from collectors_sdk.public import BaseCollector, BasicCollectorEngine
"""
...
from collectors_sdk._core.base_collector.models.expectations import (
    ExpectationResult,
    ExpectationSummary,
    ExpectationTrace,
)
...
# --- Type aliases ---
from collectors_sdk._core.base_collector.types.collector import (
    CustomConfig,
    ExpectationsList,
    SignatureGroups,
)
...
# --- Collector + Engine ---
from collectors_sdk._core.base_collector.collector import BaseCollector
from collectors_sdk._core.base_collector.engines.basic import BasicCollectorEngine

# --- Detection utils ---
from collectors_sdk._core.base_collector.utils.detection import (
    SignatureMatcher,
    _decode_value,
    _is_base64_encoded,
)
