...
class QRadarConfig:
    """Class for loading IBM QRadar configuration."""

    def __init__(self) -> None:
        """Initialize IBM QRadar configuration loader.
        ...
        self.logger.debug(f"{LOG_PREFIX} Initializing IBM QRadar configuration loader")
        self.load = self._load_config()
        self.logger.info(f"{LOG_PREFIX} IBM QRadar configuration loaded successfully")
    ...
    def _load_config(self) -> ConfigLoader:
        ...
        try:
            ...
            self.logger.debug(
                f"{LOG_PREFIX} IBM QRadar base URL: {load_settings.qradar.base_url}"
            )
