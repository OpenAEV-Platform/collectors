"""Essential tests for IBM QRadar Expectation Service."""
...
class TestQRadarExpectationServiceEssential:
    """Essential test cases for QRadarExpectationService.

    Tests the core functionality of the IBM QRadar expectation service including
    ...
    def test_init_with_valid_config(self):
        ...
        service = QRadarExpectationService(config=config)
    ...
    def test_init_without_config_raises_error(self):
        ...
        configuration raises a QRadarValidationError.
        """
        with pytest.raises(QRadarValidationError):
            QRadarExpectationService(config=None)
    ...
    def test_handle_batch_expectations_with_error(self):
        ...
        service.process_expectation = Mock(
            side_effect=QRadarExpectationError("Test error")
        )
    ...
    def test_prevention_expectation_not_supported(self):
        ...
        Verifies that IBM QRadar correctly rejects prevention expectation
    ...
    def test_match_no_data_raises_exception(self):
        ...
        raises QRadarNoAlertsFoundError.
        """
        config = create_test_config()
        service = QRadarExpectationService(config=config)
    ...
    def test_match_no_matching_alerts_raises_exception(self):
        ...
        the service raises QRadarNoMatchingAlertsError.
        """
        config = create_test_config()
        service = QRadarExpectationService(config=config)
        ...
        with pytest.raises(QRadarNoMatchingAlertsError):
            service._match(
                oaev_data, matching_signatures, mock_detection_helper, "detection"
            )
    ...
    def test_create_error_result_object(self):
        ...
        error = QRadarNoAlertsFoundError("No alerts found")
    ...
    def test_get_service_info(self):
        ...
        assert info["service_name"] == "IBM QRadar"  # noqa: S101
