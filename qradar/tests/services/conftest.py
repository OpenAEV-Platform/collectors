...
@pytest.fixture
def mock_client_api():
    """Provide a mock IBM QRadar client API.

    Returns:
        Mock IBM QRadar client API instance for testing.
...
@pytest.fixture
def sample_alert():
    """Provide a sample IBM QRadar alert.

    Returns:
        QRadarAlert instance for testing.

    """
    return QRadarAlertFactory.build()


@pytest.fixture
def sample_alerts():
    """Provide a list of sample IBM QRadar alerts.

    Returns:
        List of 3 QRadarAlert instances for testing.

    """
    return [QRadarAlertFactory.build() for _ in range(3)]
...
@pytest.fixture
def mixed_qradar_data():
    """Provide mixed IBM QRadar data (alerts).

    Returns:
        List containing QRadarAlert instances.

    """
    return TestDataFactory.create_mixed_qradar_data()
...
def api_response_data():
    ...
    Returns:
        Dictionary containing mock IBM QRadar API response.
...
@pytest.fixture
def alert_factory():
    """Provide the QRadarAlertFactory for creating alerts.

    Returns:
        QRadarAlertFactory class for generating test alerts.

    """
    return QRadarAlertFactory
