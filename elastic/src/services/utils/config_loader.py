...
class ElasticConfig:
    """Class for loading Elastic Security configuration."""

    def __init__(self) -> None:
        """Initialize Elastic Security configuration loader.
        ...
        self.logger.debug(
            f"{LOG_PREFIX} Initializing Elastic Security configuration loader"
        )
        self.load = self._load_config()
        self.logger.info(
            f"{LOG_PREFIX} Elastic Security configuration loaded successfully"
        )
