...
COLLECTOR_TYPE = "openaev_elastic"
...
class Collector(CollectorDaemon):  # type: ignore[misc]
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            self.logger.info(  # type: ignore[has-type]
                f"{LOG_PREFIX} Elastic Security Collector initialized successfully"
            )
    ...
    def _setup(self) -> None:
        ...
        Initializes Elastic Security services, expectation handler, expectation manager,
        ...
        try:
            ...
            self.logger.debug(f"{LOG_PREFIX} Initializing Elastic Security services...")

            self.elastic_service = ElasticExpectationService(self.config_instance)

            self.trace_service = ElasticTraceService(self.config_instance)

            self.expectation_handler = GenericExpectationHandler(self.elastic_service)
            ...
            supported_signatures = self.elastic_service.get_supported_signatures()
            ...
            service_info = self.elastic_service.get_service_info()
    ...
    def _process_callback(self) -> None:
        ...
        try:
            ...
            self.logger.debug(
                f"{LOG_PREFIX} Processing expectations using Elastic services"
            )
