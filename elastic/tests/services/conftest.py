...
@pytest.fixture
def mock_client_api():
    """Provide a mock Elastic Security client API.

    Returns:
        Mock Elastic Security client API instance for testing.
...
@pytest.fixture
def sample_alert():
    """Provide a sample Elastic Security alert.

    Returns:
        ElasticAlert instance for testing.

    """
    return ElasticAlertFactory.build()


@pytest.fixture
def sample_alerts():
    """Provide a list of sample Elastic Security alerts.

    Returns:
        List of 3 ElasticAlert instances for testing.

    """
    return [ElasticAlertFactory.build() for _ in range(3)]
...
@pytest.fixture
def mixed_elastic_data():
    """Provide mixed Elastic Security data (alerts).

    Returns:
        List containing ElasticAlert instances.

    """
    return TestDataFactory.create_mixed_elastic_data()
...
def api_response_data():
    ...
    Returns:
        Dictionary containing mock Elastic Security API response.
...
@pytest.fixture
def alert_factory():
    """Provide the ElasticAlertFactory for creating alerts.

    Returns:
        ElasticAlertFactory class for generating test alerts.

    """
    return ElasticAlertFactory
