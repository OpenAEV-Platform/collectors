"""Essential tests for Elastic Security Expectation Service."""
...
class TestElasticExpectationServiceEssential:
    """Essential test cases for ElasticExpectationService.

    Tests the core functionality of the Elastic Security expectation service including
    ...
    def test_init_with_valid_config(self):
        ...
        service = ElasticExpectationService(config=config)
    ...
    def test_init_without_config_raises_error(self):
        ...
        configuration raises a ElasticValidationError.
        """
    ...
    def test_handle_batch_expectations_with_error(self):
        ...
        service.process_expectation = Mock(
            side_effect=ElasticExpectationError("Test error")
        )
    ...
    def test_prevention_expectation_not_supported(self):
        ...
        Verifies that Elastic Security correctly rejects prevention expectation
    ...
    def test_match_no_data_raises_exception(self):
        ...
        raises ElasticNoAlertsFoundError.
        """
        config = create_test_config()
        service = ElasticExpectationService(config=config)
        ...
        with pytest.raises(ElasticNoAlertsFoundError):
    ...
    def test_match_no_matching_alerts_raises_exception(self):
        ...
        the service raises ElasticNoMatchingAlertsError.
        """
        config = create_test_config()
        service = ElasticExpectationService(config=config)
        ...
        with pytest.raises(ElasticNoMatchingAlertsError):
            service._match(
                oaev_data, matching_signatures, mock_detection_helper, "detection"
            )
    ...
    def test_create_error_result_object(self):
        ...
        error = ElasticNoAlertsFoundError("No alerts found")
    ...
    def test_get_service_info(self):
        ...
        assert info["service_name"] == "Elastic Security"  # noqa: S101
