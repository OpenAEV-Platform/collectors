...
class TestGithubCrawler(unittest.TestCase):
    def test_github_crawler_init(self, m_github):
        ...
        self.assertEqual(crawler.ref, m_github.return_value.get_git_ref.return_value)
        m_github.return_value.get_repo.assert_called_with(sentinel.repo_name)
        m_github.return_value.get_git_ref.assert_called_with(sentinel.ref_value)
    ...
    def test_get_json_file_paths(self, m_requests, m_github):
        ...
        m_github.return_value.get_git_ref.return_value.object.sha = "feedc0de"
