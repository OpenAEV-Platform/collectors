...
@pytest.fixture
def mock_client_api():
    """Provide a mock NetWitness client API.

    Returns:
        Mock NetWitness client API instance for testing.
...
@pytest.fixture
def sample_alert():
    """Provide a sample NetWitness alert.

    Returns:
        NetWitnessAlert instance for testing.

    """
    return NetWitnessAlertFactory.build()


@pytest.fixture
def sample_alerts():
    """Provide a list of sample NetWitness alerts.

    Returns:
        List of 3 NetWitnessAlert instances for testing.

    """
    return [NetWitnessAlertFactory.build() for _ in range(3)]
...
@pytest.fixture
def mixed_netwitness_data():
    """Provide mixed NetWitness data (alerts).

    Returns:
        List containing NetWitnessAlert instances.

    """
    return TestDataFactory.create_mixed_netwitness_data()
...
def api_response_data():
    ...
    Returns:
        Dictionary containing mock NetWitness API response.
...
@pytest.fixture
def alert_factory():
    """Provide the NetWitnessAlertFactory for creating alerts.

    Returns:
        NetWitnessAlertFactory class for generating test alerts.

    """
    return NetWitnessAlertFactory
