...
class TestCollector(unittest.TestCase):
    ...
    @patch.object(module, "NetWitnessConfig")
    def test_init(self, m_net_witness_config, m_process_callback):
        m_net_witness_config.return_value = MagicMock()
        m_net_witness_config.return_value.load.to_daemon_config.return_value = daemon_config_data

        collector = module.Collector()

        m_net_witness_config.assert_called_once()
        m_net_witness_config.return_value.load.to_daemon_config.assert_called_once()

    @patch.object(module, "NetWitnessConfig")
    def test_process_callback(self, m_net_witness_config):
        m_net_witness_config.return_value = MagicMock()
        m_net_witness_config.return_value.load.to_daemon_config.return_value = daemon_config_data
    ...
    @patch.object(module, "NetWitnessConfig")
    def test_process_callback_keyboard_interrupt(self, m_net_witness_config, m_exit):
        m_net_witness_config.return_value = MagicMock()
        m_net_witness_config.return_value.load.to_daemon_config.return_value = daemon_config_data
    ...
    @patch.object(module.os, "_exit")
    @patch.object(module, "NetWitnessConfig")
    def test_process_callback_system_exit(self, m_net_witness_config, m_exit):
        m_net_witness_config.return_value = MagicMock()
        m_net_witness_config.return_value.load.to_daemon_config.return_value = daemon_config_data
