...
class NetWitnessConfig:
    """Class for loading NetWitness configuration."""

    def __init__(self) -> None:
        """Initialize NetWitness configuration loader.
        ...
        self.logger.debug(f"{LOG_PREFIX} Initializing NetWitness configuration loader")
        self.load = self._load_config()
        self.logger.info(f"{LOG_PREFIX} NetWitness configuration loaded successfully")
    ...
    def _load_config(self) -> ConfigLoader:
        ...
        try:
            ...
            self.logger.debug(
                f"{LOG_PREFIX} NetWitness base URL: {load_settings.netwitness.base_url}"
            )
