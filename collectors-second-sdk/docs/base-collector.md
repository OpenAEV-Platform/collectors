...
```python
from collectors_second_sdk import Source
...
| Concern | Owner |
|---|---|
| BaseCollector lifecycle | `collectors-second-sdk` |
| DaemonProtocol (`start`, `set_callback`, `get_id`, `self.api`) | `xtm-oaev-sdk` (re-exported) |
| 4 Protocols | `collectors-second-sdk` |
| Data models | `collectors-second-sdk` |
| Error hierarchy | `collectors-second-sdk` |
| Config base classes | `collectors-second-sdk` |
| BasicCollectorEngine | `collectors-second-sdk` |
| ResilientUploader | `collectors-second-sdk` (internal) |
