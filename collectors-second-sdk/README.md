...
43 public symbols in `collectors_second_sdk`:
...
```python
from collectors_second_sdk import BaseCollector, Source, BasicCollectorEngine
```
...
# Error handling
from collectors_second_sdk import CollectorError, CollectorProcessingError, BulkUploadError

# Detection utilities
from collectors_second_sdk import SignatureMatcher, _decode_value
```
...
pip install -e ".[dev]"
pytest                                # run tests
pytest --cov=collectors_second_sdk    # with coverage
mypy --strict collectors_second_sdk/  # type check
ruff check collectors_second_sdk/     # lint
```
