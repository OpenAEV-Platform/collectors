...
class CollectorEngineConfigError(CollectorError):
    """Exception raised when there is an error in the collector engine configuration."""
    pass
...
class BulkUploadError(ExpectationUpdateError):
    """Exception raised when there is an error during bulk upload operations."""
    pass


class BulkPreparationError(ExpectationUpdateError):
    """Exception raised when there is an error during bulk preparation operations."""
    pass
