    ...
    def to_daemon_config(self) -> Configuration:
        return Configuration(
            config_hints={
                ...
                "hl_base_url": {"data": self.collector.base_url},
                "hl_auth_url": {"data": self.collector.auth_url},
                "hl_client_id": {"data": self.collector.client_id},
                "hl_client_secret": {"data": self.collector.client_secret},
            },
